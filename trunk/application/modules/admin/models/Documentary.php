<?php
class Admin_Model_Documentary
{    
    private static $_instance;
    private static $_table = "documentary";
    
    private function __construct() {
    }
    
    /**
     * @return Admin_Model_Documentary
     * */
    ...
    public function insert($data) {
        if(!$this->isValidDocumentary($data)) {
            return 0;
        }
    ...
    */
    ...
    private function isValidDocumentary($data, $isUpdate=false) {
        if(!$data['name'] ||
            !$data['name_seo'] ||
